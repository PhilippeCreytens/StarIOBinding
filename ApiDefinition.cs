...
namespace StarIOBinding
{
	...
	public partial interface BluetoothPort {
		...
		bool GetParsedStatus (NSObject starPrinterStatus, uint level);
		...
		bool BeginCheckedBlock (NSObject starPrinterStatus, uint level);

		// -(BOOL)endCheckedBlock:(StarPrinterStatus_2 *)starPrinterStatus level:(u_int32_t)level;
		[Export ("endCheckedBlock:level:")]
		bool EndCheckedBlock (NSObject starPrinterStatus, uint level);
	...
	[BaseType (typeof (NSStreamDelegate))]
	public partial interface WBluetoothPort {
		...
		bool GetParsedStatus (NSObject starPrinterStatus, uint level, nint timeoutSec);
	...
	public partial interface PortException {

	}

	// @interface PortInfo : NSObject
	[BaseType (typeof (NSObject))]
	public partial interface PortInfo {
	...
	public partial interface SMPort {
		...
		void GetParsedStatus (NSObject starPrinterStatus, uint level);
		...
		[Export ("beginCheckedBlock::")]
		void BeginCheckedBlock (NSObject starPrinterStatus, uint level);

		// -(void)endCheckedBlock:(void *)starPrinterStatus :(u_int32_t)level;
		[Export ("endCheckedBlock::")]
		void EndCheckedBlock (NSObject starPrinterStatus, uint level);
	...
	[BaseType (typeof (NSObject))]
	public partial interface SMBluetoothManager {
